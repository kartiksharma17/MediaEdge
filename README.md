...
MediaEdge is a Spring Boot based anime streaming platform featuring a custom CDN engine for low-latency media delivery. The application follows a modular monolithic architecture where each module has a clear responsibility while sharing the same application runtime.
